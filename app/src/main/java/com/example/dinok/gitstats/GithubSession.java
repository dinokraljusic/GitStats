...
public class GithubSession {
    ...
    public void storeRepoInternalId(Long id) {
        editor.putLong(REPO_ID, id);
        editor.commit();
    }

    public Long getRepoInternalId() {
        return sharedPref.getLong(REPO_ID, 0);
    }
